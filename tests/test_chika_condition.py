...
from game.ability import (
    ...
    Condition, ConditionType, TargetType
)
    ...
    def setUp(self):
        ...
        for i in range(100, 110):
            self.game.member_db[i] = MemberCard(
                ...
                blades=1, group="Test", unit="", img_path=""
            )
        
        # Create a mock live card for recovery
        self.game.live_db[200] = LiveCard(
            card_id=200, card_no="L200", name="Test Live", score=1,
            required_hearts=np.zeros(7, dtype=np.int32), img_path=""
        )
