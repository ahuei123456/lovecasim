...
from game.ability import Ability, TriggerType, Effect, EffectType, TargetType, AbilityCostType, Condition, ConditionType, AbilityParser
...
class TestScore4Execution(unittest.TestCase):
    ...
    def test_kanata_execution(self):
        ...
        GameState.member_db[10] = MemberCard(10, "M1", 1, np.zeros(6), np.zeros(6), 1)
        GameState.member_db[11] = MemberCard(11, "M2", 1, np.zeros(6), np.zeros(6), 1)
        ...
        GameState.live_db[100] = LiveCard(100, "L1", 1, np.zeros(7))
    ...
    def test_honoka_execution(self):
        ...
        GameState.live_db[200] = LiveCard(200, "L1", 1, np.zeros(7))
        GameState.member_db[10] = MemberCard(10, "M1", 1, np.zeros(6), np.zeros(6), 1)
