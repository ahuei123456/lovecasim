...
def reconstruct_ability(ability):
    ...
    for eff in ability.effects:
        ...
        if context.get('target') == 'card_discard': context['target'] = 'discard'
        if context.get('target') in ['member_select', 'self']: context['target'] = 'member'
        ...
        if filter_val == 'member': context['filter'] = 'Member'
        elif filter_val == 'live': context['filter'] = 'Live'
        elif filter_val == 'heart_req': context['filter'] = '(w/ Heart req)'
        else: context['filter'] = ''
