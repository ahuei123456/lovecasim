...
class SimpleNetwork:
    ...
    def train_step(
        ...
        for i in range(batch_size):
            ...
            d_hidden = d_policy @ self.policy_weight.T + d_value * self.value_weight.T.flatten()
        ...
        for i in range(len(self.hidden_weights)):
            self.hidden_weights[i] -= config.learning_rate * (grad_hidden_w[i] + config.l2_reg * self.hidden_weights[i])
        ...
        return (
            (total_policy_loss + total_value_loss) / batch_size,
