...
from game.ability import AbilityParser, Ability, TriggerType, EffectType, ConditionType, AbilityCostType
...
def generate_report():
    ...
    print(f"Report generated: tests/parsing_verification_report.md")
    print(f"Parse failures: tests/parsing_failures.txt")
    print(f"\nStats:")
