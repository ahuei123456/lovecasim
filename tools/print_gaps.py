...
def analyze_gaps(json_path, output_path):
    ...
    for card_no, data in cards.items():
        ...
        if reason:
            if reason not in gaps_by_reason: gaps_by_reason[reason] = []
...
if __name__ == "__main__":
    analyze_gaps('data/cards.json', 'C:\\Users\\trios\\.gemini\\antigravity\\brain\\977c35e4-a902-4010-b6ca-33e286754a5a\\gap_analysis.md')
