...
def run_verification():
    test_cases = [
        ("Meta Rule", "(登場能力がコストを持つ場合、支払って発動させる。)", "Clarification text about paying costs."),
        ("Select Mode", "登場以下から1つを選ぶ。", "Start of a modal ability choice."),
        (
            "Deck Ordering (Top)",
        ...
        ("Flavor Action", "ライブ開始時相手に何が好き？と聞く。", "Joke/Flavor effect asking opponent a question."),
        ("Set Score", "ライブ成功時このカードのスコアは４になる。", "Overriding score calculation to fixed value 4."),
        (
            "Place Under",
