...
try:
    from ability import Ability, AbilityCostType, Condition, TriggerType  # noqa: F401
...
def test_rule_11_2_once_per_turn():
    ...
    m1 = MemberCard(card_id=999, name="Test Idol", cost=1, hearts=hearts, blade_hearts=blade_hearts, blades=1)
