            ...
            for action in activate_actions:
                ...
                if card_id in state.member_db:
                    ...
                    try:
                        ...
                        if not any([hand_delta > 0, energy_delta > 0, stage_changed, choice_pending]) and tap_delta <= 0:
...
def run_simulation(args):
    ...
    print(f"Best Game was Game {best_game_idx+1} with Score Total {best_combined_score if best_combined_score >= 0 else 0}")
